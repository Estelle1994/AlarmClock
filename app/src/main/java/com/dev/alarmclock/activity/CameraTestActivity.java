...
import com.dev.alarmclock.view.AutoFitTextureView;
...
/**
 * Created by ${Estelle} on 2018/6/8.
 */
...
public class CameraTestActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        clShow = (ConstraintLayout) findViewById(R.id.cl_show);
        picture = (ImageView) findViewById(R.id.iv_picture_show);
        share = (TextView) findViewById(R.id.btn_share);
        ...
        switch (v.getId()){
            ...
            case R.id.iv_switch:
                if (mCameraId .equals("0")) {
                    mCameraId = "1";
                    Toast.makeText(this,mCameraId,Toast.LENGTH_SHORT).show();
            ...
            cameraDevice.createCaptureSession(Arrays.asList(surface
                    , imageReader.getSurface()), new CameraCaptureSession.StateCallback() // ③
                    {
                        ...
                        public void onConfigureFailed(CameraCaptureSession cameraCaptureSession) {
                            Toast.makeText(CameraTestActivity.this, "配置失败！"
                    ...
                    new ImageReader.OnImageAvailableListener() {
                        ...
                        public void onImageAvailable(ImageReader reader) {
                            ...
                            try (
                                ...
                                output.write(bytes);
                                Toast.makeText(CameraTestActivity.this, "保存: " + file, Toast.LENGTH_LONG).show();
                            } catch (Exception e) {
                                e.printStackTrace();
                            } finally {
                                image.close();
